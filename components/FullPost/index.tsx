  ...
  return (
    <Paper elevation={0} className={styles.paper}>
      ...
      <div className={styles.text}>
        ...
        <p>
          Казалось бы, вот он — успешный успех, о котором мечтает каждый стартап. Как бы не так 😄 Помимо тысяч клиентов
          и первой выручки, я получил все прелести выхода на рынок «сырого» продукта, стал жертвой неопытности в общении
          с корпорациями и чуть не забыл о том, для чего вообще создавал Машу.
        </p>
